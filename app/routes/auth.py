...
from app.schemas.user_schemas import UserSchemaOut, LoginSchemaIn, LoginSchemaOut
...
@router.get("/me", tags=[tag], summary="Returns data of logged user", response_model=UserSchemaOut)
async def me(current_user: User = Depends(get_current_user)):
    result = UserSchemaOut.from_orm(current_user)
    return result
