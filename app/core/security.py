...
def check_permission(current_user: User, user_permission: PermissionEnum):
    ...
    if user_permission == PermissionEnum.OWER:
        list_permited.append(PermissionEnum.OWER)
...
def check_is_ower_user(current_user: User = Depends(get_current_user)):
    return check_permission(current_user, PermissionEnum.OWER)