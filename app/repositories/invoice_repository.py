...
from app.schemas.invoice_schemas import InvoiceLogSchemaOut, InvoiceSchemaOut, InvoiceBillingSchemaOut, InvoiceSchemaIn
...
class InvoiceRepository:
    ...
    def create_invoice_reference(self, reference: str):
        invoice = Invoice(
